...
VALID_FLOAT_TYPE = ['float64', 'float32']
VALID_INTEGER_TYPE = ['int64', 'int32']
...
VALID_TYPES_WITHOUT_DATE = [VALID_STRING_TYPE, VALID_CATEGORICAL_TYPE] + VALID_FLOAT_TYPE + VALID_INTEGER_TYPE
