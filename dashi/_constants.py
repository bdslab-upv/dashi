...
# Types
VALID_DATE_TYPES= ['datetime64[ns]', 'datetime64[us]', 'datetime64[ms]', 'datetime64[s]']
VALID_FLOAT_TYPE1 = ['float64', 'float32']
VALID_FLOAT_TYPE2 = 'float32'
VALID_INTEGER_TYPE1 = ['int64', 'int32']
...
VALID_TYPES_WITHOUT_DATE = [VALID_STRING_TYPE, VALID_CATEGORICAL_TYPE] + VALID_FLOAT_TYPE1 + VALID_INTEGER_TYPE1
VALID_TYPES = VALID_TYPES_WITHOUT_DATE + VALID_DATE_TYPES
